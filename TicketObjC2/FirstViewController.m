...
- (void)createContentDataArray {
    NSArray *titles = [NSArray arrayWithObjects:NSLocalizedString(@"about_app_header", ""),
                       NSLocalizedString(@"tickets_header", ""),
                       NSLocalizedString(@"map_price_header", ""),
                       NSLocalizedString(@"favorites_header", ""), nil];
    NSArray *contents = [NSArray arrayWithObjects:NSLocalizedString(@"about_app_describe", ""),
